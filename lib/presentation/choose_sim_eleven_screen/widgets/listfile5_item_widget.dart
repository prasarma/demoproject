...
import '../models/listfile5_item_model.dart';
import 'package:flutter/material.dart';
import 'package:pra_s_application2/core/app_export.dart';

// ignore: must_be_immutable
class Listfile5ItemWidget extends StatelessWidget {
  Listfile5ItemWidget(this.listfile5ItemModelObj);

  Listfile5ItemModel listfile5ItemModelObj;

  var controller = Get.find<ChooseSimElevenController>();
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Obx(
                  () => Text(
                    listfile5ItemModelObj.simCounterTxt.value,
                ...
                Padding(
                  ...
                  child: Obx(
                    () => Text(
                      listfile5ItemModelObj.vodafoneTxt.value,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,

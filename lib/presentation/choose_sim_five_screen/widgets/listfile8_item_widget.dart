...
import '../models/listfile8_item_model.dart';
import 'package:flutter/material.dart';
import 'package:pra_s_application2/core/app_export.dart';

// ignore: must_be_immutable
class Listfile8ItemWidget extends StatelessWidget {
  Listfile8ItemWidget(this.listfile8ItemModelObj);

  Listfile8ItemModel listfile8ItemModelObj;
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Obx(
                  () => Text(
                    listfile8ItemModelObj.simCounterTxt.value,
                ...
                Padding(
                  ...
                  child: Obx(
                    () => Text(
                      listfile8ItemModelObj.vodafoneTxt.value,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,

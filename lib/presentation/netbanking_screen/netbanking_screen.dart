import '../netbanking_screen/widgets/gridmenu1_item_widget.dart';
import '../netbanking_screen/widgets/listcheckmark_item_widget.dart';
import '../netbanking_screen/widgets/listsettings2_item_widget.dart';
...
import 'models/listsettings2_item_model.dart';
...
class NetbankingScreen extends GetWidget<NetbankingController> {
  @override
                        ...
                        Align(
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              ...
                              children: [
                                CustomImageView(
                                  imagePath: ImageConstant.imgEllipse41766x270,
                                  height: getVerticalSize(
                                    66,
                                  ),
                                  width: getHorizontalSize(
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              children: [
                                CustomImageView(
                                  svgPath:
                                      ImageConstant.imgLocationYellow90053x53,
                                  height: getSize(
                                    53,
                                  ),
                                  width: getSize(
                          ...
                          children: [
                            Expanded(
                              child: CustomIconButton(
                                ...
                                child: CustomImageView(
                                  svgPath: ImageConstant.imgGrid43x43,
                                ),
                              ),
                            ),
                            Expanded(
                            ...
                            Expanded(
                              child: CustomIconButton(
                                ...
                                child: CustomImageView(
                                  svgPath:
                                      ImageConstant.imgCalendarYellow90043x43,
                                ),
                              ),
                            ),
                            Expanded(
                              ...
                              Padding(
                                ...
                                child: Obx(
                                  () => ListView.separated(
                                    ...
                                    itemCount: controller.netbankingModelObj
                        ...
                        child: Padding(
                          ...
                          child: Obx(
                            () => GridView.builder(
                              ...
                              physics: NeverScrollableScrollPhysics(),
                              itemCount: controller.netbankingModelObj.value
                                  .gridmenu1ItemList.length,
                              itemBuilder: (context, index) {
                                Gridmenu1ItemModel model = controller
                                    .netbankingModelObj
                                    .value
                                    .gridmenu1ItemList[index];
                                return Gridmenu1ItemWidget(
                                  model,
                                );
                              },
                            ),
                            ...
                            Container(
                              ...
                              child: Stack(
                                children: [
                                  CustomImageView(
                                    svgPath: ImageConstant
                                        .imgAsset1hand1BlueGray9000166x88,
                                    height: getVerticalSize(
                                      66,
                                    ),
                                    width: getHorizontalSize(
                                              ...
                                              child: Obx(
                                                () => ListView.separated(
                                                  ...
                                                  itemCount: controller
                                                      .netbankingModelObj
                                                      .value
                                                      .listsettings2ItemList
                                                      .length,
                                                  itemBuilder:
                                                      (context, index) {
                                                    Listsettings2ItemModel
                                                        model = controller
                                                            .netbankingModelObj
                                                            .value
                                                            .listsettings2ItemList[index];
                                                    return Listsettings2ItemWidget(
                                                      model,
                                                    );
                                                  },
                                                ),

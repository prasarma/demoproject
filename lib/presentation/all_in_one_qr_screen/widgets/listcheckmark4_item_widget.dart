...
import '../models/listcheckmark4_item_model.dart';
...
class Listcheckmark4ItemWidget extends StatelessWidget {
  Listcheckmark4ItemWidget(this.listcheckmark4ItemModelObj);

  Listcheckmark4ItemModel listcheckmark4ItemModelObj;
                          ...
                          child: Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Obx(
                                  () => Text(
                                    listcheckmark4ItemModelObj.sixtyTxt.value,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.left,
                                    style:

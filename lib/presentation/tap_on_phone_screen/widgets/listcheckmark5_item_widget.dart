...
class Listcheckmark5ItemWidget extends StatelessWidget {
  Listcheckmark5ItemWidget(this.listcheckmark5ItemModelObj);

  Listcheckmark5ItemModel listcheckmark5ItemModelObj;

  var controller = Get.find<TapOnPhoneController>();
                          ...
                          child: Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Obx(
                                  () => Text(
                                    listcheckmark5ItemModelObj.sixtyTxt.value,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.left,
                                    style:

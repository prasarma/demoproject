import '../tap_on_phone_screen/widgets/gridmenu6_item_widget.dart';
import '../tap_on_phone_screen/widgets/listcheckmark5_item_widget.dart';
import '../tap_on_phone_screen/widgets/listsettings7_item_widget.dart';
import 'controller/tap_on_phone_controller.dart';
import 'models/gridmenu6_item_model.dart';
import 'models/listcheckmark5_item_model.dart';
...
class TapOnPhoneScreen extends GetWidget<TapOnPhoneController> {
  @override
                        ...
                        Align(
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              ...
                              children: [
                                CustomImageView(
                                  imagePath: ImageConstant.imgEllipse4175,
                                  height: getVerticalSize(
                                    66,
                                  ),
                                  width: getHorizontalSize(
                          ...
                          children: [
                            Expanded(
                              child: CustomIconButton(
                                ...
                                child: CustomImageView(
                                  svgPath: ImageConstant.imgGrid5,
                                ),
                              ),
                            ),
                            Expanded(
                            ...
                            Expanded(
                              child: CustomIconButton(
                                ...
                                shape: IconButtonShape.RoundedBorder22,
                                child: CustomImageView(
                                  svgPath: ImageConstant.imgCalendar4,
                                ),
                              ),
                            ),
                            Expanded(
                              ...
                              Padding(
                                ...
                                child: Obx(
                                  () => ListView.separated(
                                    ...
                                    itemCount: controller.tapOnPhoneModelObj
                                        .value.listcheckmark5ItemList.length,
                                    itemBuilder: (context, index) {
                                      Listcheckmark5ItemModel model = controller
                                          .tapOnPhoneModelObj
                                          .value
                                          .listcheckmark5ItemList[index];
                                      return Listcheckmark5ItemWidget(
                                        model,
                                      );
                                    },
                                  ),
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          ...
                                          textAlign: TextAlign.left,
                                          style: AppStyle
                                              .txtHelveticaNeue11Bluegray8007e,
                                        ),
                                      ),
                                    ),
                                  ],
                        ...
                        child: Padding(
                          ...
                          child: Obx(
                            () => GridView.builder(
                              ...
                              physics: NeverScrollableScrollPhysics(),
                              itemCount: controller.tapOnPhoneModelObj.value
                                  .gridmenu6ItemList.length,
                              itemBuilder: (context, index) {
                                Gridmenu6ItemModel model = controller
                                    .tapOnPhoneModelObj
                                    .value
                                    .gridmenu6ItemList[index];
                                return Gridmenu6ItemWidget(
                                  model,
                                );
                              },
                            ),
                          ...
                          children: [
                            Container(
                              ...
                              child: Stack(
                                children: [
                                  CustomImageView(
                                    svgPath: ImageConstant.imgAsset1hand14,
                                    height: getVerticalSize(
                                      66,
                                    ),
                                    width: getHorizontalSize(
                                              ...
                                              child: Obx(
                                                () => ListView.separated(
                                                  ...
                                                  itemCount: controller
                                                      .tapOnPhoneModelObj
                                                      .value
                                                      .listsettings7ItemList
                                                      .length,
                                                  itemBuilder:
                                                      (context, index) {
                                                    Listsettings7ItemModel
                                                        model = controller
                                                            .tapOnPhoneModelObj
                                                            .value
                                                            .listsettings7ItemList[index];
                                                    return Listsettings7ItemWidget(
                                                      model,
                                                    );
                                                  },
                                                ),
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: fs.Svg(
                                ImageConstant.imgGroup3243WhiteA700356x340,
                              ),
                              fit: BoxFit.cover,
                            ),
                          ),
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      CustomImageView(
                                        svgPath:
                                            ImageConstant.imgCloseGray80001,
                                        height: getSize(
                                          13,
                                        ),
                                        width: getSize(

import 'package:pra_s_application2/core/app_export.dart';import 'package:pra_s_application2/presentation/business_details_individual_three_screen/models/business_details_individual_three_model.dart';import 'package:flutter/material.dart';class BusinessDetailsIndividualThreeController extends GetxController {TextEditingController group620Controller = TextEditingController();

TextEditingController group619Controller = TextEditingController();

TextEditingController group617Controller = TextEditingController();
...
@override void onClose() { super.onClose(); group620Controller.dispose(); group619Controller.dispose(); group617Controller.dispose(); } 

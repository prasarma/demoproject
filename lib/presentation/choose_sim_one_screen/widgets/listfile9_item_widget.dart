...
import '../models/listfile9_item_model.dart';
import 'package:flutter/material.dart';
import 'package:pra_s_application2/core/app_export.dart';

// ignore: must_be_immutable
class Listfile9ItemWidget extends StatelessWidget {
  Listfile9ItemWidget(this.listfile9ItemModelObj);

  Listfile9ItemModel listfile9ItemModelObj;
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Obx(
                  () => Text(
                    listfile9ItemModelObj.simCounterTxt.value,
                ...
                Padding(
                  ...
                  child: Obx(
                    () => Text(
                      listfile9ItemModelObj.vodafoneTxt.value,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,

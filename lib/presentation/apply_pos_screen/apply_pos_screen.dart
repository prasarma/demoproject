import '../apply_pos_screen/widgets/gridmenu4_item_widget.dart';
import '../apply_pos_screen/widgets/listcheckmark3_item_widget.dart';
import '../apply_pos_screen/widgets/listsettings5_item_widget.dart';
...
import 'models/listsettings5_item_model.dart';
...
class ApplyPosScreen extends GetWidget<ApplyPosController> {
  @override
                        ...
                        Align(
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              ...
                              children: [
                                CustomImageView(
                                  imagePath: ImageConstant.imgEllipse4173,
                                  height: getVerticalSize(
                                    66,
                                  ),
                                  width: getHorizontalSize(
                                      ...
                                      child: Obx(
                                        () => ListView.separated(
                                          ...
                                          itemCount: controller
                                              .applyPosModelObj
                                              .value
                                              .listcheckmark3ItemList
                                              .length,
                                          itemBuilder: (context, index) {
                                            Listcheckmark3ItemModel model =
                                                controller
                                                        .applyPosModelObj
                                                        .value
                                                        .listcheckmark3ItemList[
                        ...
                        child: Padding(
                          ...
                          child: Obx(
                            () => GridView.builder(
                              ...
                              itemCount: controller.applyPosModelObj.value
                                  .gridmenu4ItemList.length,
                              itemBuilder: (context, index) {
                                Gridmenu4ItemModel model = controller
                                    .applyPosModelObj
                                    .value
                                    .gridmenu4ItemList[index];
                                return Gridmenu4ItemWidget(
                                  model,
                                );
                              },
                            ),
                          ...
                          children: [
                            Container(
                              ...
                              child: Stack(
                                children: [
                                  CustomImageView(
                                    svgPath: ImageConstant.imgAsset1hand12,
                                    height: getVerticalSize(
                                      66,
                                    ),
                                    width: getHorizontalSize(
                                              ...
                                              child: Obx(
                                                () => ListView.separated(
                                                  ...
                                                  itemCount: controller
                                                      .applyPosModelObj
                                                      .value
                                                      .listsettings5ItemList
                                                      .length,
                                                  itemBuilder:
                                                      (context, index) {
                                                    Listsettings5ItemModel
                                                        model = controller
                                                                .applyPosModelObj
                                                                .value
                                                                .listsettings5ItemList[
                                                            index];
                                                    return Listsettings5ItemWidget(
                                                      model,
                                                    );
                                                  },
                                                ),
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: fs.Svg(
                                ImageConstant.imgGroup3243WhiteA700,
                              ),
                              fit: BoxFit.cover,
                            ),
                          ),

import '../aadhar_screen/widgets/gridmenu3_item_widget.dart';
import '../aadhar_screen/widgets/listcheckmark2_item_widget.dart';
import '../aadhar_screen/widgets/listsettings4_item_widget.dart';
import 'controller/aadhar_controller.dart';
import 'models/gridmenu3_item_model.dart';
import 'models/listcheckmark2_item_model.dart';
import 'models/listsettings4_item_model.dart';
                        ...
                        Align(
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              ...
                              children: [
                                CustomImageView(
                                  imagePath: ImageConstant.imgEllipse4172,
                                  height: getVerticalSize(
                                    66,
                                  ),
                                  width: getHorizontalSize(
                              ...
                              Padding(
                                ...
                                child: Obx(
                                  () => ListView.separated(
                                    ...
                                    itemCount: controller.aadharModelObj.value
                                        .listcheckmark2ItemList.length,
                        ...
                        child: Padding(
                          ...
                          child: Obx(
                            () => GridView.builder(
                              ...
                              physics: NeverScrollableScrollPhysics(),
                              itemCount: controller.aadharModelObj.value
                                  .gridmenu3ItemList.length,
                              itemBuilder: (context, index) {
                                Gridmenu3ItemModel model = controller
                                    .aadharModelObj
                                    .value
                                    .gridmenu3ItemList[index];
                                return Gridmenu3ItemWidget(
                                  model,
                                );
                              },
                            ),
                          ...
                          children: [
                            Container(
                              ...
                              child: Stack(
                                children: [
                                  CustomImageView(
                                    svgPath: ImageConstant.imgAsset1hand11,
                                    height: getVerticalSize(
                                      66,
                                    ),
                                    width: getHorizontalSize(
                                              ...
                                              child: Obx(
                                                () => ListView.separated(
                                                  ...
                                                  itemCount: controller
                                                      .aadharModelObj
                                                      .value
                                                      .listsettings4ItemList
                                                      .length,
                                                  itemBuilder:
                                                      (context, index) {
                                                    Listsettings4ItemModel
                                                        model = controller
                                                                .aadharModelObj
                                                                .value
                                                                .listsettings4ItemList[
                                                            index];
                                                    return Listsettings4ItemWidget(
                                                      model,
                                                    );
                                                  },
                                                ),

...
class Gridmenu3ItemWidget extends StatelessWidget {
  Gridmenu3ItemWidget(this.gridmenu3ItemModelObj);

  Gridmenu3ItemModel gridmenu3ItemModelObj;
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Obx(
                () => Text(
                  gridmenu3ItemModelObj.upicollectTxt.value,
                  maxLines: null,

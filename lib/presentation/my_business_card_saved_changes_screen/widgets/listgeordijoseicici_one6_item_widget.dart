...
import '../models/listgeordijoseicici_one6_item_model.dart';
...
class ListgeordijoseiciciOne6ItemWidget extends StatelessWidget {
  ListgeordijoseiciciOne6ItemWidget(this.listgeordijoseiciciOne6ItemModelObj);

  ListgeordijoseiciciOne6ItemModel listgeordijoseiciciOne6ItemModelObj;
                    ...
                    child: Stack(
                      ...
                      children: [
                        Align(
                          ...
                          child: Obx(
                            () => Text(
                              listgeordijoseiciciOne6ItemModelObj

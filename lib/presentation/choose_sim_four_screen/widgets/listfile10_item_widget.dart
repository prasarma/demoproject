...
import '../models/listfile10_item_model.dart';
...
class Listfile10ItemWidget extends StatelessWidget {
  Listfile10ItemWidget(this.listfile10ItemModelObj);

  Listfile10ItemModel listfile10ItemModelObj;

  var controller = Get.find<ChooseSimFourController>();
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Obx(
                  () => Text(
                    listfile10ItemModelObj.simCounterTxt.value,
                ...
                Padding(
                  ...
                  child: Obx(
                    () => Text(
                      listfile10ItemModelObj.vodafoneTxt.value,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,

...
class ListgeordijoseiciciOne3ItemWidget extends StatelessWidget {
  ListgeordijoseiciciOne3ItemWidget(this.listgeordijoseiciciOne3ItemModelObj);

  ListgeordijoseiciciOne3ItemModel listgeordijoseiciciOne3ItemModelObj;

  var controller = Get.find<GuestMerchantDashboardWithLiveServicesController>();
                    ...
                    child: Stack(
                      ...
                      children: [
                        Align(
                          ...
                          child: Obx(
                            () => Text(
                              listgeordijoseiciciOne3ItemModelObj

...
class ListgeordijoseiciciOne1ItemWidget extends StatelessWidget {
  ListgeordijoseiciciOne1ItemWidget(this.listgeordijoseiciciOne1ItemModelObj);

  ListgeordijoseiciciOne1ItemModel listgeordijoseiciciOne1ItemModelObj;

  var controller =
      Get.find<GuestMerchantDashboardWithLiveServicesOneController>();
                    ...
                    child: Stack(
                      ...
                      children: [
                        Align(
                          ...
                          child: Obx(
                            () => Text(
                              listgeordijoseiciciOne1ItemModelObj

import 'package:pra_s_application2/core/app_export.dart';import 'package:pra_s_application2/presentation/business_details_individual_eight_screen/models/business_details_individual_eight_model.dart';import 'package:flutter/material.dart';class BusinessDetailsIndividualEightController extends GetxController {TextEditingController group785Controller = TextEditingController();

TextEditingController group784Controller = TextEditingController();

TextEditingController group782Controller = TextEditingController();
...
@override void onClose() { super.onClose(); group785Controller.dispose(); group784Controller.dispose(); group782Controller.dispose(); } 

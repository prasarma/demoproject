...
import '../models/listfile11_item_model.dart';
import 'package:flutter/material.dart';
import 'package:pra_s_application2/core/app_export.dart';

// ignore: must_be_immutable
class Listfile11ItemWidget extends StatelessWidget {
  Listfile11ItemWidget(this.listfile11ItemModelObj);

  Listfile11ItemModel listfile11ItemModelObj;
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Obx(
                  () => Text(
                    listfile11ItemModelObj.simCounterTxt.value,
                ...
                Padding(
                  ...
                  child: Obx(
                    () => Text(
                      listfile11ItemModelObj.vodafoneTxt.value,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,

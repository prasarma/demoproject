...
import '../models/listgeordijoseicici_one4_item_model.dart';
...
class ListgeordijoseiciciOne4ItemWidget extends StatelessWidget {
  ListgeordijoseiciciOne4ItemWidget(this.listgeordijoseiciciOne4ItemModelObj);

  ListgeordijoseiciciOne4ItemModel listgeordijoseiciciOne4ItemModelObj;
                    ...
                    child: Stack(
                      ...
                      children: [
                        Align(
                          ...
                          child: Obx(
                            () => Text(
                              listgeordijoseiciciOne4ItemModelObj
